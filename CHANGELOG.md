...
- The ability to filter which entries to process based on their keys.
- The ability to output either one file per entry or a single combined file for all entries.
...
[unreleased]: https://github.com/anirbanbasu/bibtera/compare/v0.0.1...HEAD
