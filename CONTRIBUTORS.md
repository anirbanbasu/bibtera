...
The BibTera project and its maintainers take security vulnerabilities seriously.
...
If you think you have identified a security issue with the BibTera project, _do not open a public issue_. To responsibly report a security issue, please navigate to the "Security" tab for the repository, and click "[Report a vulnerability](https://github.com/anirbanbasu/bibtera/security/advisories/new)".
...
While using BibTera, we recommend:
